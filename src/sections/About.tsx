        ...
        <div>
            ...
            <div className="px-[7%] flex ">
                ...
                <div className="flex-1 flex flex-col justify-center gap-4">
                    <p className="text-2xl font-bold">Nishant Singh Yadav</p>
                    <p className="text-lg font-thin text-blue-400">Front-end Developer</p>
                    <p className="">Hello! 🎉<br /> I'm a professional Front-End Developer from Mohali (Punjab), holding a Bachelor's degree in Computer Science from Chandigarh University. 🎓<br /> Since my first year of college, I have been passionate about web development. 💻 My focus is on creating attractive and functional websites and applications. I also have a love for building interactive UIs and engaging in side projects. 🚀</p>
                    <div> <button
                        type="button"
